 ...
 */
@Component
public class ${type}${name}MessageHandler extends LoginHandler<${type}${name}Message> {

    @Override
    public void execute(Channel channel, ${type}${name}Message message,int playerId) {
        //TODO 请在这里写下你的代码

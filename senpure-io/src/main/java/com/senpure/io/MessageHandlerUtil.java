...
import com.senpure.io.message.MesssageHandler;
...
public class MessageHandlerUtil {
    private static Map<Integer, MesssageHandler> handlerMap = new HashMap<>();
    ...
    public static MesssageHandler getHandler(int messageId) {
        return handlerMap.get(messageId);
    }
    public static void regMessageHandler(MesssageHandler handler) {
    ...
    public static Message getEmptyMessage(int messageId) {
        MesssageHandler handler = handlerMap.get(messageId);
        if (handler == null) {
            return null;
        }

...
public abstract class Bean {
    ...
    public static int computeStringSize(int tag, String value) {
        return computeVar32Size(tag) + computeStringSizeNoTag(value);
    }
    ...
    public static int computeBeanSize(int tag, Bean value) {
        return computeVar32Size(tag) + computeBeanSizeNoTag(value);
    }
    ...
    public static int computeBooleanSize(int tag, boolean value) {
        return computeVar32Size(tag) + computeBooleanSizeNoTag(value);
    }
    ...
    public static int computeDoubleSize(int tag, double value) {
        return computeVar32Size(tag) + computeDoubleSizeNoTag(value);
    }
    ...
    public static int computeFloatSize(int tag, float value) {
        return computeVar32Size(tag) + computeFloatSizeNoTag(value);
    }
    ...
    public static int computeSFixed32Size(int tag, int value) {
        return computeVar32Size(tag) + computeSFixed32SizeNoTag(value);
    }
    ...
    public static int computeSFixed64Size(int tag, long value) {
        return computeVar32Size(tag) + computeSFixed64SizeNoTag(value);
    }
    ...
    public static int computeSIntSize(int tag, int value) {
        return computeVar32Size(tag) + computeSIntSizeNoTag(value);
    }
    ...
    public static int computeSLongSize(int tag, long value) {
        return computeVar32Size(tag) + computeSLongSizeNoTag(value);
    }
    ...
    public static int computeVar32Size(int tag, int value) {
        return computeVar32Size(tag) + computeVar32SizeNoTag(value);
    ...
    public static int computeVar64Size(int tag, long value) {
        return computeVar32Size(tag) + computeVar64SizeNoTag(value);

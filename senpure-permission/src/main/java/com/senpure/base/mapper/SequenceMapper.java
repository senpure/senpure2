...
public interface SequenceMapper {
     ...
     * @return 影响的行数
     */
    int deleteByCriteria(SequenceCriteria criteria);
     ...
     * @return 影响的行数
     */
    int saveBatch(List<Sequence> sequences);
     ...
     * @return 影响的行数
     */
    int updateByCriteria(SequenceCriteria criteria);
     ...
     * @return 满足条件的总行数
     */
    int countByCriteria(SequenceCriteria criteria);
     ...
     * @return 满足条件的记录
     */
    List<Sequence> findByCriteria(SequenceCriteria criteria);
}

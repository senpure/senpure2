...
public interface URIPermissionMapper {
     ...
     * @return 影响的行数
     */
    int deleteByCriteria(URIPermissionCriteria criteria);
     ...
     * @return 影响的行数
     */
    int save(URIPermission uriPermission);
     ...
     * @return 影响的行数
     */
    int saveBatch(List<URIPermission> uriPermissions);
     ...
     * @return 影响的行数
     */
    int cover(URIPermission uriPermission);
     ...
     * @return 影响的行数
     */
    int updateByCriteria(URIPermissionCriteria criteria);
     ...
     * @return 满足条件的总行数
     */
    int countByCriteria(URIPermissionCriteria criteria);
     ...
     * @return 满足条件的记录
     */
    List<URIPermission> findByCriteria(URIPermissionCriteria criteria);
}

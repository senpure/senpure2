...
<head>
    <title>proxy list-/demo/proxies/${criteria.page!}</title>
<#include "../cssjs.ftl">
</head>
<body>
...
<#include "../top.ftl">
    ...
    <#include "../menu.ftl">
        <div class="col-sm-10 "> <!--center col-sm-10 start -->
            <form id="criteria" action="/demo/proxies"
        ...
        <div <#include "../pageDivAttr.ftl">>
            ...
            <#list items as item>
                <tr>
                    ...
                    <td>
                    <#if item.bindTime??>
                        ${item.bindTime?number_to_datetime?string(datetime_format)}
                    </#if>
                    </td>
                    <td>
                        <a href="/demo/proxy/${item.id?c}"
                           onclick="deleteProxyConfirm(this,'${item.id?c}');return false;"
                        >
...
<script type="text/javascript">
    ...
    deleteProxy()
    {
        ...
        $.ajax({
            "url": "/demo/proxy/" + id, "success": function (resp) {
    ...
    function deleteProxyConfirm(obj, id) {
        ...
        $("#confirm .modal-footer .btn-success").on("click", deleteProxy);
    }

...
<head>
    <title>clazz list-/demo/clazzs/${criteria.page!}</title>
<#include "../cssjs.ftl">
</head>
<body>
...
<#include "../top.ftl">
    ...
    <#include "../menu.ftl">
        <div class="col-sm-10 "> <!--center col-sm-10 start -->
            <form id="criteria" action="/demo/clazzs"
        ...
        <div <#include "../pageDivAttr.ftl">>
            ...
            <#list items as item>
                <tr>
                    ...
                    <td>
                        <a href="/demo/clazz/${item.id?c}"
                           onclick="deleteClazzConfirm(this,'${item.id?c}');return false;"
                        >
...
<script type="text/javascript">
    ...
    deleteClazz()
    {
        ...
        $.ajax({
            "url": "/demo/clazz/" + id, "success": function (resp) {
    ...
    function deleteClazzConfirm(obj, id) {
        ...
        $("#confirm .modal-footer .btn-success").on("click", deleteClazz);
    }
